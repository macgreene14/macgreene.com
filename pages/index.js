      ...
      <div className="bg-white px-6 py-8 lg:px-8 rounded-lg">
        <div className="mx-auto max-w-xl text-base leading-7 text-gray-700">
          ...
          <p className="mt-6 text-xl leading-8">
            ...
            taste better. Based out of Bozeman, Montana. Contact today for a
            free consultation.
          </p>
            ...
            <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
              ...
              <li className="flex gap-x-3">
                ...
                <span>
                  ...
                  Services ranging from small utility functions to full stack
                  web applications.
                </span>
              </li>
              <li className="flex gap-x-3">
                ...
                <span>
                  ...
                  Customized software infrastructure to streamline your critical
                  business activities.
                </span>
              </li>
              <li className="flex gap-x-3">
              ...
              <li className="flex gap-x-3">
                ...
                <span>
                  ...
                  Create standardized, integrated operating procedures using
                  online services such as Confluence and Jira.
                </span>
              </li>
            </ul>
          </div>
